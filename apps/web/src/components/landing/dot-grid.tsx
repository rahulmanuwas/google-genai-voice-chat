  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle, hsl(38 92% 50%) 0.75px, transparent 0.75px)',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, hsl(38 92% 50% / 0.12) 0%, hsl(38 92% 50% / 0.04) 40%, transparent 70%)',
          filter: 'blur(60px)',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, hsl(350 50% 40% / 0.06) 0%, transparent 70%)',
          filter: 'blur(80px)',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, hsl(20 70% 50% / 0.05) 0%, transparent 70%)',
          filter: 'blur(60px)',
